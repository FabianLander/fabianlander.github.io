...
date: 2025-02-27
description: "A practical guide to creating and using Python virtual environments for PyTorch development."
tags:
  - python
  - pytorch
  - machine-learning
...
subset_train = torch.utils.data.Subset(mnist_train, range(10000))
